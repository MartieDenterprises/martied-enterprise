...
let products = [
    { id: 1, name: "Laundry Net", category: "household", price: 1800, image: "laundry-net.jpeg", badge: "", description: "Durable mesh net for protecting clothes in the washing machine.", stock: 50, soldToday: 3 },
    { id: 2, name: "Portable Rechargeable Juicer", category: "kitchenware", price: 4500, image: "portable-juicer.jpeg", badge: "hot", description: "USB rechargeable mini blender. Perfect for smoothies on the go.", stock: 30, soldToday: 5 },
    { id: 3, name: "Potato Peeler", category: "kitchenware", price: 1800, image: "potato-peeler.jpeg", badge: "", description: "Sharp stainless steel blade with comfortable grip handle.", stock: 60, soldToday: 2 },
    { id: 4, name: "2 Step Soap Case", category: "household", price: 1600, image: "soap-case.jpeg", badge: "", description: "Drainage soap dish with two-tier design. Keeps soap dry.", stock: 45, soldToday: 1 },
    { id: 5, name: "6 Way Aluminium Grater", category: "kitchenware", price: 3500, image: "aluminium-grater.jpeg", badge: "", description: "Multi-purpose grater with 6 different blade styles.", stock: 35, soldToday: 2 },
    { id: 6, name: "Lunch Bag (Insulated)", category: "household", price: 2600, image: "lunch-bag.jpeg", badge: "", description: "Thermal insulated lunch bag. Keeps food warm or cold.", stock: 40, soldToday: 3 },
    { id: 7, name: "Gym/Student Size Towel", category: "household", price: 2500, image: "gym-towel.jpeg", badge: "", description: "Compact quick-dry towel. Perfect for gym, travel, or school.", stock: 55, soldToday: 4 },
    { id: 8, name: "Bowl - Dozen", category: "kitchenware", price: 7500, image: "bowl-dozen.jpeg", badge: "", description: "Set of 12 colorful plastic bowls. Stackable and durable.", stock: 25, soldToday: 1 },
    { id: 9, name: "Fruit Basket - Dozen", category: "kitchenware", price: 6500, image: "fruit-basket.jpeg", badge: "", description: "12-piece fruit basket set. Elegant design for serving.", stock: 20, soldToday: 2 },
   ...
   /* { id: 140, name: "Mini True wireless stereo Earbuds", category: "gadgets", price: 5500, image: "mini-wireless-earbuds.jpeg", badge: "", description: "True wireless stereo earbuds with charging case.", stock: 0, soldToday: 9999 },*/
    { id: 141, name: "Expandable Foldable Rolling Travel luggage", category: "gifts", price: 18000, image: "expandable-travel-luggage.jpeg", badge: "", description: "Expandable foldable rolling travel luggage. Multiple sizes.", stock: 12, soldToday: 2 },
    { id: 142, name: "2.02-inch watch screen", category: "gadgets", price: 15500, image: "2inch-watch-screen.jpeg", badge: "", description: "Smart watch with 2.02-inch HD screen. Fitness tracking.", stock: 25, soldToday: 4 },
    { id: 143, name: "Cloth Hanger", category: "household", price: 4000, image: "cloth-hanger.jpeg", badge: "", description: "Colorful plastic cloth hangers. Durable and lightweight.", stock: 70, soldToday: 10 },
    { id: 144, name: "Moimoi Plate Dozen", category: "kitchenware", price: 5500, image: "moimoi-plate-dozen.jpeg", badge: "", description: "12-piece moimoi cooking plate set. Reusable aluminum.", stock: 45, soldToday: 6 },
    { id: 145, name: "Maxi Microwave Oven 20L", category: "kitchenware", price: 63000, image: "maxi-microwave-20l.jpeg", badge: "", description: "20-liter maxi microwave oven. Multiple cooking modes.", stock: 8, soldToday: 1 },
    { id: 146, name: "Divider bowl", category: "kitchenware", price: 15500, image: "divider-bowl.jpeg", badge: "", description: "Multi-compartment divider bowl. Perfect for portion control.", stock: 20, soldToday: 3 },
    { id: 147, name: "Floral Ceramic Set", category: "kitchenware", price: 8500, image: "floral-ceramic-set.jpeg", badge: "", description: "Beautiful floral ceramic dinner set. Microwave safe.", stock: 30, soldToday: 4 },
    { id: 148, name: "Small-size round Tray Dozen", category: "kitchenware", price: 5800, image: "small-round-tray-dozen.jpeg", badge: "", description: "12-piece small round tray set. Perfect for serving.", stock: 40, soldToday: 5 },
    { id: 149, name: "32pcs Dinner set", category: "kitchenware", price: 30000, image: "32pcs-dinner-set.jpeg", badge: "", description: "32-piece complete dinner set. Elegant tableware.", stock: 12, soldToday: 2 },
    { id: 150, name: "Microwave-compatible bowl sm-7000 Dozen", category: "kitchenware", price: 9000, image: "microwave-bowl-dozen.jpeg", badge: "", description: "12-piece microwave-compatible bowl set. Heat resistant.", stock: 35, soldToday: 5 },
    { id: 151, name: "Stainless Kettle", category: "kitchenware", price: 10500, image: "stainless-kettle.jpeg", badge: "", description: "Stainless steel electric kettle. Fast boiling.", stock: 35, soldToday: 5 },
    { id: 152, name: "N68 Handheld Cooling Fan", category: "gadgets", price: 6000, image: "n68-handheld-fan.jpeg", badge: "", description: "N68 handheld cooling fan. 100 speed adjustment settings.", stock: 45, soldToday: 8 },
    { id: 153, name: "Peg with Basket", category: "household", price: 2000, image: "peg-with-basket.jpeg", badge: "", description: "Cloth pegs with storage basket. 24 pegs included.", stock: 60, soldToday: 12 },
    { id: 154, name: "5-layer Fruit Basket", category: "kitchenware", price: 48000, image: "5layer-fruit-basket.jpeg", badge: "", description: "5-tier fruit and vegetable storage basket. Rotating design.", stock: 8, soldToday: 1 },
    { id: 155, name: "Influencer Light", category: "gadgets", price: 9000, image: "influencer-light.jpeg", badge: "", description: "Ring light for content creators. Adjustable brightness.", stock: 30, soldToday: 5 },
    { id: 156, name: "Pimple Patch (Transparent Pack)", category: "personal", price: 1800, image: "pimple-patch.jpeg", badge: "", description: "Transparent pimple patches. Invisible acne treatment.", stock: 70, soldToday: 15 },
    { id: 157, name: "Fruit Storage", category: "household", price: 3300, image: "fruit-storage.jpeg", badge: "", description: "Stackable fruit storage container. Keep fruits fresh.", stock: 50, soldToday: 8 },
    { id: 158, name: "Dish Drainer 8 cm", category: "kitchenware", price: 45000, image: "dish-drainer-8cm.jpeg", badge: "", description: "8cm dish drainer rack. Large capacity drying.", stock: 10, soldToday: 2 },
    { id: 159, name: "jug.", category: "kitchenware", price: 12000, image: "jug.jpeg", badge: "", description: "Elegant ceramic jug. Perfect for serving drinks.", stock: 25, soldToday: 4 },
    { id: 160, name: "7 pcs. silicone spoons", category: "kitchenware", price: 7000, image: "7pcs-silicone-spoons.jpeg", badge: "", description: "7-piece silicone spoon set. Heat resistant and non-stick.", stock: 40, soldToday: 6 },
    { id: 161, name: "Multifunctional Washing and Flushing", category: "household", price: 18000, image: "multifunctional-washing-flushing.jpeg", badge: "", description: "Multifunctional washing and flushing machine. Portable.", stock: 15, soldToday: 2 },
    { id: 162, name: "Collapsible Storage rack", category: "household", price: 26000, image: "collapsible-storage-rack.jpeg", badge: "", description: "Collapsible rolling storage rack. Space-saving design.", stock: 12, soldToday: 2 },
    { id: 163, name: "3065 Sokany Steaming Iron", category: "household", price: 25500, image: "sokany-steaming-iron.jpeg", badge: "", description: "Sokany 3065 steam iron. Powerful wrinkle removal.", stock: 15, soldToday: 3 },
    { id: 164, name: "5-in-1 Laundry Detergent beads for long-lasting fragrance & stain remover", category: "household", price: 5000, image: "laundry-detergent-beads.jpeg", badge: "", description: "5-in-1 laundry detergent beads. Fragrance and stain removal.", stock: 50, soldToday: 10 },
    { id: 165, name: "Bardefu 5052 8-in-1 Blender", category: "kitchenware", price: 50000, image: "bardefu-8in1-blender.jpeg", badge: "", description: "Bardefu 5052 8-in-1 multi-function blender. Professional.", stock: 8, soldToday: 1 },
    { id: 166, name: "RAF infrared Cooker", category: "kitchenware", price: 33000, image: "raf-infrared-cooker.jpeg", badge: "", description: "RAF infrared electric cooker. Fast and energy efficient.", stock: 12, soldToday: 2 },
    { id: 167, name: "Kitchen Cutlery (Black & Grey Color)", category: "kitchenware", price: 25500, image: "kitchen-cutlery-black-grey.jpeg", badge: "", description: "Black and grey kitchen cutlery set. Modern design.", stock: 15, soldToday: 3 },
    { id: 168, name: "Glass 5pcs Storage", category: "kitchenware", price: 26500, image: "glass-5pcs-storage.jpeg", badge: "", description: "5-piece glass storage container set. Airtight lids.", stock: 14, soldToday: 2 },
    { id: 169, name: "Nordic Table", category: "decor", price: 22500, image: "nordic-table.jpeg", badge: "", description: "Nordic minimalist side table. Elegant wood finish.", stock: 18, soldToday: 3 },
    { id: 170, name: "Smoothie Jar", category: "kitchenware", price: 2000, image: "smoothie-jar.jpeg", badge: "", description: "Glass smoothie jar with straw. Reusable and eco-friendly.", stock: 60, soldToday: 12 },
    { id: 171, name: "Sokany 8in1 Mixer", category: "kitchenware", price: 38000, image: "sokany-8in1-mixer.jpeg", badge: "", description: "Sokany 8-in-1 hand mixer. Multiple attachments.", stock: 12, soldToday: 2 },
    { id: 172, name: "By20(6619) Sokany Hand Mixer", category: "kitchenware", price: 14500, image: "sokany-hand-mixer.jpeg", badge: "", description: "Sokany By20 hand mixer. Powerful motor.", stock: 25, soldToday: 4 },
    { id: 173, name: "Watch Ultra 3 pro smart watch with Gaming pad", category: "gadgets", price: 18500, image: "watch-ultra-3-pro.jpeg", badge: "", description: "Ultra 3 Pro smart watch with gaming controller.", stock: 20, soldToday: 3 },
    { id: 174, name: "Creative Alarm Clock", category: "decor", price: 3500, image: "creative-alarm-clock.jpeg", badge: "", description: "Creative alarm clock with modern design. Silent movement.", stock: 45, soldToday: 8 },
    { id: 175, name: "Oval shape Center Table", category: "decor", price: 70000, image: "oval-center-table.jpeg", badge: "", description: "Oval shaped center table. Luxury living room furniture.", stock: 6, soldToday: 1 },
    { id: 176, name: "Center Table", category: "decor", price: 70000, image: "center-table.jpeg", badge: "", description: "Modern center table. Elegant living room piece.", stock: 6, soldToday: 1 },
    { id: 177, name: "18-inch Rechargeable Fan", category: "household", price: 65000, image: "18inch-rechargeable-fan.jpeg", badge: "", description: "18-inch rechargeable standing fan. Long battery life.", stock: 8, soldToday: 1 },
    { id: 178, name: "Hair Scrunchie Dozen", category: "personal", price: 4500, image: "hair-scrunchie-dozen.jpeg", badge: "", description: "12-piece colorful hair scrunchie set. Soft fabric.", stock: 50, soldToday: 10 },
    { id: 179, name: "Changing Lipstick", category: "personal", price: 900, image: "changing-lipstick.jpeg", badge: "", description: "Color-changing lipstick. Reacts to your body temperature.", stock: 80, soldToday: 20 },
    { id: 180, name: "24 hr Hot 1000 ml ALI GIN Food Flask with Spoon", category: "household", price: 15500, image: "24hr-food-flask.jpeg", badge: "", description: "24-hour hot 1000ml food flask with spoon. Vacuum insulated.", stock: 25, soldToday: 4 },
    ...
    { id: 184, name: "Paloma Food Processor 8-in-1", category: "kitchenware", price: 130000, image: "paloma-food-processor.jpeg", badge: "", description: "Paloma 8-in-1 food processor. Multi-function kitchen tool.", stock: 5, soldToday: 1 },
    { id: 185, name: "42 pcs. Arts Coloring Sets.", category: "gifts", price: 3200, image: "arts-coloring-set.jpeg", badge: "", description: "42-piece art coloring set. Perfect for kids and adults.", stock: 55, soldToday: 9 },
    { id: 186, name: "5 pcs Non-Punching Corner Multipurpose Shelf", category: "household", price: 15500, image: "corner-multipurpose-shelf.jpeg", badge: "", description: "5-piece corner shelf set. No drilling required.", stock: 22, soldToday: 4 },
];
