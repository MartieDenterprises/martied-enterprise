...
let products = [
    ...
    { id: 187, name: "Cloth Bag 66L", category: "bags", price: 7000, image: "cloth-bag-66l.jpg", badge: "", description: "66 liter cloth storage bag. Spacious and durable.", stock: 9990, soldToday: 2 },
    { id: 188, name: "Cloth Bag 100L", category: "bags", price: 8000, image: "cloth-bag-100l.jpg", badge: "", description: "100 liter large cloth storage bag. Heavy duty material.", stock: 9995, soldToday: 120 },
    { id: 189, name: "Small Auto Folding Umbrella", category: "umbrella", price: 3200, image: "small-auto-folding-umbrella.jpg", badge: "", description: "Compact auto-folding umbrella. Easy one-touch open/close.", stock: 9990, soldToday: 49 },
    { id: 190, name: "Umbrella", category: "umbrella", price: 2700, image: "umbrella-2700.jpg", badge: "", description: "Standard umbrella. Reliable rain protection.", stock: 9990, soldToday: 40 },
    { id: 191, name: "Umbrella", category: "umbrella", price: 3000, image: "umbrella-3000.jpg", badge: "", description: "Quality umbrella. Wind-resistant frame.", stock: 9990, soldToday: 60 },
    { id: 192, name: "Big Foldable Umbrella", category: "umbrella", price: 4500, image: "big-foldable-umbrella.jpg", badge: "", description: "Large foldable umbrella. Extra coverage for heavy rain.", stock: 9990, soldToday: 20 },
    { id: 193, name: "Remikins Plate by 6", category: "kitchenware", price: 13000, image: "remikins-plate-6.jpg", badge: "", description: "Set of 6 Remikins plates. Elegant dining set.", stock: 9990, soldToday: 30 },
    { id: 194, name: "Travel Bag", category: "bags", price: 17000, image: "travel-bag.jpg", badge: "", description: "Spacious travel bag. Durable and stylish for trips.", stock: 8925, soldToday: 55 },
    { id: 195, name: "6 in 1 Candy Set", category: "gifts", price: 15500, image: "6in1-candy-set.jpg", badge: "", description: "6-in-1 assorted candy gift set. Perfect for gifting.", stock: 990, soldToday: 23 },
    { id: 196, name: "3 in 1 Tray", category: "kitchenware", price: 13000, image: "3in1-tray-3.jpg", badge: "", description: "Versatile 3-in-1 serving tray set.", stock: 9990, soldToday: 33 },
    { id: 197, name: "3 in 1 Clipper", category: "personal", price: 10500, image: "3in1-clipper.jpg", badge: "", description: "3-in-1 hair clipper set. Professional grooming kit.", stock: 9930, soldToday: 105 },
    { id: 198, name: "Manicure Set", category: "personal", price: 1500, image: "manicure-set.jpg", badge: "", description: "Complete manicure set. Nail care essentials.", stock: 9960, soldToday: 220 },
    { id: 199, name: "Bladeless Fan", category: "gadgets", price: 6000, image: "bladeless-fan.jpg", badge: "", description: "Safe bladeless fan. Modern design, child-friendly.", stock: 9995, soldToday: 10 },
    { id: 200, name: "Juicer", category: "kitchenware", price: 14000, image: "juicer.jpg", badge: "", description: "Electric juicer. Extract fresh juice easily.", stock: 9995, soldToday: 20 },
    { id: 201, name: "Pot", category: "kitchenware", price: 130000, image: "pot.jpg", badge: "", description: "Premium cooking pot. High-quality durable build.", stock: 9999, soldToday: 26 },
    { id: 202, name: "Auto Face Tracker with Light", category: "gadgets", price: 32000, image: "auto-face-tracker-light.jpg", badge: "", description: "Auto-tracking phone holder with built-in ring light. Perfect for content creators.", stock: 9995, soldToday: 19 },
    { id: 203, name: "10 Inches Pad", category: "gadgets", price: 95000, image: "10inches-pad.jpg", badge: "", description: "10-inch tablet pad. Large screen for work and entertainment.", stock: 9990, soldToday: 15 },
    { id: 204, name: "Learning Pad", category: "gadgets", price: 6500, image: "learning-pad.jpg", badge: "", description: "Educational learning pad for kids. Interactive screen.", stock: 9990, soldToday: 81 },
    { id: 205, name: "Learning Computer", category: "gadgets", price: 7000, image: "learning-computer.jpg", badge: "", description: "Kids learning computer. Educational games and activities.", stock: 9999, soldToday: 36 },
    { id: 206, name: "Plastic Cup", category: "gifts", price: 7000, image: "plastic-cup-dozen.jpg", badge: "", description: "Plastic cup set. 7000 per dozen. Great for events and gifting.", stock: 9990, soldToday: 22 },
    { id: 207, name: "3 in 1 Kenwood Blender", category: "kitchenware", price: 50000, image: "3in1-kenwood-blender.jpg", badge: "", description: "Kenwood 3-in-1 multi-function blender. Professional grade.", stock: 9992, soldToday: 100 },
    { id: 208, name: "Jewelry Box", category: "gifts", price: 9500, image: "jewelry-box.jpg", badge: "", description: "Elegant jewelry box. Perfect for storing and organizing accessories.", stock: 9990, soldToday: 12 },
    { id: 209, name: "3pcs Water Bottle", category: "gifts", price: 6500, image: "3pcs-water-bottle.jpg", badge: "", description: "Set of 3 water bottles. Perfect for family or gifting.", stock: 9990, soldToday: 60 },
    { id: 210, name: "Cartoon Handheld Fan", category: "gadgets", price: 4500, image: "cartoon-handheld-fan.jpg", badge: "", description: "Portable cartoon handheld fan. 6 different colors available.", stock: 9960, soldToday: 80 },
    { id: 211, name: "Professional Hair Clipper", category: "personal", price: 8000, image: "professional-hair-clipper.jpg", badge: "", description: "Professional grade hair clipper. Sharp blades, precise cuts.", stock: 9930, soldToday: 220 },
    { id: 212, name: "3 in 1 Charging Cable", category: "gadgets", price: 7000, image: "3in1-charging-cable.jpg", badge: "", description: "3-in-1 multi-function charging cable. Compatible with all phone types.", stock: 9995, soldToday: 120 },
    { id: 213, name: "Borosilicate Glass Cup and Jug", category: "kitchenware", price: 9500, image: "borosilicate-glass-cup-jug.jpg", badge: "", description: "Heat-resistant borosilicate glass cup and jug set. Elegant design.", stock: 9925, soldToday: 56 },
    { id: 214, name: "Cup Hot and Cold", category: "kitchenware", price: 9500, image: "cup-hot-cold.jpg", badge: "", description: "Temperature control cup. Keeps drinks hot or cold for hours.", stock: 9990, soldToday: 10 },
    { id: 215, name: "Lip Gloss", category: "personal", price: 1000, image: "lip-gloss.jpg", badge: "", description: "Shiny lip gloss. Single piece.", stock: 9900, soldToday: 30 },
    { id: 216, name: "Lip Gloss Dozen", category: "personal", price: 11000, image: "lip-gloss-dozen.jpg", badge: "", description: "Lip gloss dozen pack. 12 pieces at bulk price.", stock: 9990, soldToday: 52 },
    { id: 217, name: "Lingben Rechargeable Fan AC/DC", category: "household", price: 35000, image: "lingben-rechargeable-fan.jpeg", badge: "", description: "Lingben rechargeable fan with AC/DC dual power. Reliable cooling anywhere.", stock: 9915, soldToday: 70 },
    { id: 218, name: "Duravolt Solar Power Generator with Panel", category: "gadgets", price: 140000, image: "duravolt-solar-generator.jpeg", badge: "", description: "Duravolt solar power generator complete with panel. Clean energy backup.", stock: 9995, soldToday: 40 },
    { id: 219, name: "150W Portable Power Station", category: "gadgets", price: 120000, image: "150w-portable-power-station.jpeg", badge: "", description: "150W portable power station. Compact emergency power solution.", stock: 9996, soldToday: 230 },
    { id: 220, name: "Iwin Hand Fan", category: "gadgets", price: 4500, image: "iwin-hand-fan.jpeg", badge: "", description: "Iwin portable hand fan. 6pcs and above at ₦4,000 each.", stock: 5990, soldToday: 81 },
    { id: 221, name: "DP Desktop Rechargeable Fan 8000mAh", category: "household", price: 22000, image: "dp-desktop-rechargeable-fan.jpeg", badge: "", description: "DP desktop rechargeable fan with 8000mAh battery. Long-lasting cooling.", stock: 882, soldToday: 9 },
    { id: 222, name: "DP 3000mAh Water Mist Hand Fan", category: "gadgets", price: 9000, image: "dp-water-mist-hand-fan.jpeg", badge: "", description: "DP water mist hand fan with 3000mAh battery. Cooling mist spray.", stock: 9985, soldToday: 10 },
    { id: 223, name: "10000mAh Powerbank", category: "gadgets", price: 12000, image: "10000mah-powerbank.jpeg", badge: "", description: "10000mAh high-capacity powerbank. Fast charging on the go.", stock: 9990, soldToday: 30 },
    { id: 224, name: "Yobolife Solar Digital Kit Big Size", category: "gadgets", price: 26000, image: "yobolife-solar-digital-kit.jpeg", badge: "", description: "Yobolife solar digital kit. Big size with full accessories.", stock: 9995, soldToday: 22 },
    { id: 225, name: "Iwin Rechargeable Desktop Fan", category: "household", price: 16000, image: "iwin-rechargeable-desktop-fan.jpeg", badge: "", description: "Iwin rechargeable desktop fan. Portable and powerful.", stock: 18, soldToday: 110 },
    { id: 226, name: "Kamisafe Telescopic Remote Control Circulation Fan", category: "household", price: 52000, image: "kamisafe-telescopic-fan.jpeg", badge: "", description: "Kamisafe telescopic circulation fan with remote control. Adjustable height.", stock: 8999, soldToday: 30 },
    { id: 227, name: "Mug Cups 48pcs", category: "gifts", price: 24000, image: "mug-cups-48pcs.jpeg", badge: "", description: "Mug cups bulk pack. 48 pieces at ₦24,000. Great for events.", stock: 9920, soldToday: 40 },
    { id: 228, name: "Mug Cup", category: "gifts", price: 4500, image: "mug-cup.jpeg", badge: "", description: "Single mug cup. Durable ceramic.", stock: 6000, soldToday: 10 },
];
